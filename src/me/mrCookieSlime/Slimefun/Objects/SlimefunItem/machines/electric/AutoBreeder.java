...
public class AutoBreeder extends SlimefunItem implements InventoryBlock {
	...
	public AutoBreeder(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack[] recipe) {
		...
		createPreset(this, "&6Auto criador", this::constructMenu);
		...
		addItemHandler(new BlockTicker() {
			...
			public void tick(Block b, SlimefunItem sf, Config data) {
				try {
					...
					Slimefun.getLogger().log(Level.SEVERE, "Se produjo un error al hacer clic en un reproductor automático para Slimefun " + Slimefun.getVersion(), x);
				}
			}
