...
public class SlimefunItems {
	...
	/*		 Weapons 		*/
	public static final ItemStack GRANDMAS_WALKING_STICK = new CustomItem(Material.STICK, "&7Bastón de la abuela", 0, new String[0], new String[] {"KNOCKBACK-2"});
	public static final ItemStack GRANDPAS_WALKING_STICK = new CustomItem(Material.STICK, "&7Bastón de la abuela", 0, new String[0], new String[] {"KNOCKBACK-5"});
	...
	public static final ItemStack BLADE_OF_VAMPIRES = new CustomItem(Material.GOLDEN_SWORD, "&cEspada vampírica", 0, new String[] {"&7Life Steal I", "", "&rCada vez que atacas algo", "&rtienes un 45% de posibilidades de", "&rrecuperar 2 corazones de tu salud"}, new String[] {"FIRE_ASPECT-2", "DURABILITY-4", "DAMAGE_ALL-2"});
	...
	public static final ItemStack HERCULES_PICKAXE = new CustomItem(Material.IRON_PICKAXE, "&9Pico de Hércules", 0, new String[] {"", "&rTan poderoso que", "&raplasta todos los minerales extraídos", "&ren polvo..."}, new String[] {"DURABILITY-2", "DIG_SPEED-4"});
	...
	public static final ItemStack COBALT_PICKAXE = new CustomItem(Material.IRON_PICKAXE, "&9Pico de cobalto", 0, new String[0], new String[] {"DURABILITY-3", "DIG_SPEED-6"});
	...
	public static final ItemStack CACTUS_HELMET = new CustomArmor(new CustomItem(Material.LEATHER_HELMET, "&2Casco de cactus", 0, new String[0], new String[] {"THORNS-3", "DURABILITY-5"}), Color.GREEN);
	public static final ItemStack CACTUS_CHESTPLATE = new CustomArmor(new CustomItem(Material.LEATHER_CHESTPLATE, "&2Pechera de cactus", 0, new String[0], new String[] {"THORNS-3", "DURABILITY-5"}), Color.GREEN);
	public static final ItemStack CACTUS_LEGGINGS = new CustomArmor(new CustomItem(Material.LEATHER_LEGGINGS, "&2Pantalones de cactus", 0, new String[0], new String[] {"THORNS-3", "DURABILITY-5"}), Color.GREEN);
	public static final ItemStack CACTUS_BOOTS = new CustomArmor(new CustomItem(Material.LEATHER_BOOTS, "&2Botas de cactus", 0, new String[0], new String[] {"THORNS-3", "DURABILITY-5"}), Color.GREEN);
	public static final ItemStack DAMASCUS_STEEL_HELMET = new CustomItem(Material.IRON_HELMET, "&7Casco de Acero damasco", new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-4"}, 0);
	public static final ItemStack DAMASCUS_STEEL_CHESTPLATE = new CustomItem(Material.IRON_CHESTPLATE, "&7Pechera de Acero damasco", new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-4"}, 0);
	public static final ItemStack DAMASCUS_STEEL_LEGGINGS = new CustomItem(Material.IRON_LEGGINGS, "&7Pantalones de Acero damasco", new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-4"}, 0);
	public static final ItemStack DAMASCUS_STEEL_BOOTS = new CustomItem(Material.IRON_BOOTS, "&7Botas de Acero damasco", new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-4"}, 0);
	public static final ItemStack REINFORCED_ALLOY_HELMET = new CustomItem(Material.IRON_HELMET, "&bCasco reforzado", new String[] {"DURABILITY-9", "PROTECTION_ENVIRONMENTAL-9"}, 0);
	public static final ItemStack REINFORCED_ALLOY_CHESTPLATE = new CustomItem(Material.IRON_CHESTPLATE, "&bPechera reforzado", new String[] {"DURABILITY-9", "PROTECTION_ENVIRONMENTAL-9"}, 0);
	public static final ItemStack REINFORCED_ALLOY_LEGGINGS = new CustomItem(Material.IRON_LEGGINGS, "&bPantalones reforzado", new String[] {"DURABILITY-9", "PROTECTION_ENVIRONMENTAL-9"}, 0);
	public static final ItemStack REINFORCED_ALLOY_BOOTS = new CustomItem(Material.IRON_BOOTS, "&bBotas reforzado", new String[] {"DURABILITY-9", "PROTECTION_ENVIRONMENTAL-9"}, 0);
	...
	public static final ItemStack GILDED_IRON_HELMET = new CustomItem(Material.GOLDEN_HELMET, "&6Casco de Hierro dorado", new String[] {"DURABILITY-6", "PROTECTION_ENVIRONMENTAL-8"}, 0);
	public static final ItemStack GILDED_IRON_CHESTPLATE = new CustomItem(Material.GOLDEN_CHESTPLATE, "&6Pechera de Hierro dorado", new String[] {"DURABILITY-6", "PROTECTION_ENVIRONMENTAL-8"}, 0);
	public static final ItemStack GILDED_IRON_LEGGINGS = new CustomItem(Material.GOLDEN_LEGGINGS, "&6Pantalones de Hierro dorado", new String[] {"DURABILITY-6", "PROTECTION_ENVIRONMENTAL-8"}, 0);
	public static final ItemStack GILDED_IRON_BOOTS = new CustomItem(Material.GOLDEN_BOOTS, "&6Botas de Hierro dorado", new String[] {"DURABILITY-6", "PROTECTION_ENVIRONMENTAL-8"}, 0);
	public static final ItemStack GOLD_HELMET = new CustomItem(Material.GOLDEN_HELMET, "&6Casco de oro puro", 0, new String[] {"&912-Quilates"}, new String[] {"DURABILITY-10"});
	public static final ItemStack GOLD_CHESTPLATE = new CustomItem(Material.GOLDEN_CHESTPLATE, "&6Pechera de oro puro", 0, new String[] {"&912-Quilates"}, new String[] {"DURABILITY-10"});
	public static final ItemStack GOLD_LEGGINGS = new CustomItem(Material.GOLDEN_LEGGINGS, "&6Pantalones de oro puro", 0, new String[] {"&912-Quilates"}, new String[] {"DURABILITY-10"});
	public static final ItemStack GOLD_BOOTS = new CustomItem(Material.GOLDEN_BOOTS, "&6Botas de oro puro", 0, new String[] {"&912-Quilates"}, new String[] {"DURABILITY-10"});
	public static final ItemStack SLIME_HELMET_STEEL = new CustomItem(Material.IRON_HELMET, "&a&lCasco de slime", 0, new String[] {"&7&oReforzado", "", "&a&oSe siente rebotable"}, new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-2"});
	public static final ItemStack SLIME_CHESTPLATE_STEEL = new CustomItem(Material.IRON_CHESTPLATE, "&a&lPechera de slime", 0, new String[] {"&7&oReforzado", "", "&a&oSe siente rebotable"}, new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-2"});
	public static final ItemStack SLIME_LEGGINGS_STEEL = new CustomItem(Material.IRON_LEGGINGS, "&a&lPantalones de slime", 0, new String[] {"&7&oReforzado", "", "&a&oSe siente rebotable", "", "&9+ Speed"}, new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-2"});
	public static final ItemStack SLIME_BOOTS_STEEL = new CustomItem(Material.IRON_BOOTS, "&a&lBotas de slime", 0, new String[] {"&7&oReforzado", "", "&a&oSe siente rebotable", "", "&9+ Jump Boost", "&9+ No Fall Damage"}, new String[] {"DURABILITY-4", "PROTECTION_ENVIRONMENTAL-2"});
	public static final ItemStack BOOTS_OF_THE_STOMPER = new CustomArmor(new CustomItem(Material.LEATHER_BOOTS, "&bBotas of the Stomper", "", "&9All Fall Damage you receive", "&9will be applied to nearby Mobs/Players", "", "&9+ No Fall Damage"), Color.AQUA);
	public static final ItemStack HEAVY_METAL_HELMET = new CustomItem(Material.IRON_HELMET, "&cCasco pesado", 0, new String[] {"", "&9+ Fuerza", "&9+ Lentitud"}, new String[] {"DURABILITY-10", "PROTECTION_ENVIRONMENTAL-10"});
	public static final ItemStack HEAVY_METAL_CHESTPLATE = new CustomItem(Material.IRON_CHESTPLATE, "&cPechera pesada", 0, new String[] {"", "&9+ Fuerza", "&9+ Lentitud"}, new String[] {"DURABILITY-10", "PROTECTION_ENVIRONMENTAL-10"});
	public static final ItemStack HEAVY_METAL_LEGGINGS = new CustomItem(Material.IRON_LEGGINGS, "&cPantalones pesados", 0, new String[] {"", "&9+ Fuerza", "&9+ Lentitud"}, new String[] {"DURABILITY-10", "PROTECTION_ENVIRONMENTAL-10"});
	public static final ItemStack HEAVY_METAL_BOOTS = new CustomItem(Material.IRON_BOOTS, "&cBotas pesadas", 0, new String[] {"", "&9+ Fuerza", "&9+ Lentitud"}, new String[] {"DURABILITY-10", "PROTECTION_ENVIRONMENTAL-10"});
...
/*		 Misc 		*/
	...
	public static final ItemStack STAFF_WIND = new CustomItem(Material.STICK, "&6Cetro Elemental &7- &b&oViento", 0, new String[] {"", "&7Elemento: &b&oViento", "", "&7&eClick Derecho&7 para lanzarse hacia adelante"}, new String[] {"LUCK-1"});
	public static final ItemStack STAFF_FIRE = new CustomItem(Material.STICK, "&6Cetro Elemental &7- &c&oFuego", 0, new String[] {"", "&7Elemento: &c&oFuego"}, new String[] {"FIRE_ASPECT-5"});
	public static final ItemStack STAFF_WATER = new CustomItem(Material.STICK, "&6Cetro Elemental &7- &1&oAgua", 0, new String[] {"", "&7Elemento: &1&oAgua", "", "&7&eClick Derecho&7 para extinguirte"}, new String[] {"WATER_WORKER-1"});
	...
	/*		Electricity			*/
	public static final ItemStack SOLAR_GENERATOR = new CustomItem(Material.DAYLIGHT_DETECTOR, "&bGenerador solar", "", "&eGenerador basico", "&8\u21E8 &e\u26A1 &70 J Buffer", "&8\u21E8 &e\u26A1 &74 J/s");
	public static final ItemStack SOLAR_GENERATOR_2 = new CustomItem(Material.DAYLIGHT_DETECTOR, "&cGenerador solar avanzado", "", "&aGenerador medio", "&8\u21E8 &e\u26A1 &70 J Buffer", "&8\u21E8 &e\u26A1 &716 J/s");
	public static final ItemStack SOLAR_GENERATOR_3 = new CustomItem(Material.DAYLIGHT_DETECTOR, "&4Generador solar Carbonado", "", "&4Generador End-Game", "&8\u21E8 &e\u26A1 &70 J Buffer", "&8\u21E8 &e\u26A1 &764 J/s");
	...
	public static final ItemStack ELECTRIC_FURNACE_3 = new CustomItem(Material.FURNACE, "&cHorno eléctrico &7- &eIII", "", "&aMáquina mid-game", "&8\u21E8 &7Velocidad: 4x", "&8\u21E8 &e\u26A1 &710 J/s");
	
	public static final ItemStack ELECTRIC_ORE_GRINDER = new CustomItem(Material.FURNACE, "&cAmoladora de mineral eléctrica", "","&rFunciona como una trituradora de mineral y piedra amoladora", "", "&6Maquina avanzada", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &712 J/s");
	public static final ItemStack ELECTRIC_ORE_GRINDER_2 = new CustomItem(Material.FURNACE, "&cAmoladora de mineral eléctrica &7(&eII&7)", "","&rFunciona como una trituradora de mineral y piedra amoladora", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 4x", "&8\u21E8 &e\u26A1 &730 J/s");
	public static final ItemStack ELECTRIC_INGOT_PULVERIZER = new CustomItem(Material.FURNACE, "&cPulverizador de lingotes eléctrico", "", "&rPulveriza lingotes en polvo", "", "&aMáquina mid-game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &714 J/s");
	public static final ItemStack AUTO_DRIER = new CustomItem(Material.SMOKER, "&eSecadora automática", "", "&aMáquina mid-game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &710 J/s");
	public static final ItemStack AUTO_ENCHANTER = new CustomItem(Material.ENCHANTING_TABLE, "&5Encantador automático", "", "&aMáquina mid-game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &718 J/s");
	public static final ItemStack AUTO_DISENCHANTER = new CustomItem(Material.ENCHANTING_TABLE, "&5Desencantador automático", "", "&aMáquina mid-game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &718 J/s");
	public static final ItemStack AUTO_ANVIL = new CustomItem(Material.GRINDSTONE, "&7Auto Yunque", "", "&6Maquina avanzada", "&8\u21E8 &7Factor de reparación: 10%", "&8\u21E8 &e\u26A1 &724 J/s");
	public static final ItemStack AUTO_ANVIL_2 = new CustomItem(Material.GRINDSTONE, "&7Auto Yunque Mk.II", "", "&4Maquina End-Game", "&8\u21E8 &7Factor de reparación: 25%", "&8\u21E8 &e\u26A1 &732 J/s");
	
	public static final ItemStack BIO_REACTOR = new CustomItem(getSkull("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjNhNThiZWM2NTY2OGI2ODJhYmFiMzYxMzAwYTljNDEzM2JiNmMwNmRiODg0NzIxMGE2MmI4ODRlZTZmYmM3ZCJ9fX0="), "&2Bio Reactor", "", "&6Generador promedio", "&8\u21E8 &e\u26A1 &7128 J Buffer", "&8\u21E8 &e\u26A1 &78 J/s");
	...
	public static final ItemStack ELECTRIC_SMELTERY = new CustomItem(Material.FURNACE, "&cFundicion electrica", "", "&4Solo aleaciones, no funden polvo en lingotes", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &720 J/s");
	public static final ItemStack ELECTRIC_SMELTERY_2 = new CustomItem(Material.FURNACE, "&cFundicion electrica &7- &eII", "", "&4Solo aleaciones, no funden polvo en lingotes", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 3x", "&8\u21E8 &e\u26A1 &740 J/s");
	
	public static final ItemStack ELECTRIFIED_CRUCIBLE = new CustomItem(Material.RED_TERRACOTTA, "&cCrisol electrificado", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &748 J/s");
	public static final ItemStack ELECTRIFIED_CRUCIBLE_2 = new CustomItem(Material.RED_TERRACOTTA, "&cCrisol electrificado &7- &eII", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 2x", "&8\u21E8 &e\u26A1 &780 J/s");
	public static final ItemStack ELECTRIFIED_CRUCIBLE_3 = new CustomItem(Material.RED_TERRACOTTA, "&cCrisol electrificado &7- &eIII", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 4x", "&8\u21E8 &e\u26A1 &7120 J/s");

	public static final ItemStack CARBON_PRESS = new CustomItem(Material.BLACK_STAINED_GLASS, "&cPrensa de carbono", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &720 J/s");
	public static final ItemStack CARBON_PRESS_2 = new CustomItem(Material.BLACK_STAINED_GLASS, "&cPrensa de carbono &7- &eII", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 3x", "&8\u21E8 &e\u26A1 &750 J/s");
	public static final ItemStack CARBON_PRESS_3 = new CustomItem(Material.BLACK_STAINED_GLASS, "&cPrensa de carbono &7- &eIII", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 15x", "&8\u21E8 &e\u26A1 &7180 J/s");
	...
	public static final ItemStack NETHER_DRILL = new CustomItem(Material.RED_TERRACOTTA, "&4Taladro del nether", "", "&rPermita minar el hielo del nether", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &7102 J/s", "", "&c&l! &cSolo se puede usar en el Nether", "&c&l! &cAsegúrate de Geo-Escanear el Chunk primero");
	...
	public static final ItemStack AUTO_BREEDER = new CustomItem(Material.HAY_BLOCK, "&eAuto-Breeder", "", "&rFunciona con &aComida Orgánica", "", "&4Maquina End-Game", "&8\u21E8 &e\u26A1 &71024 J Buffer", "&8\u21E8 &e\u26A1 &760 J/Animal");;
	...
	public static final ItemStack ANIMAL_GROWTH_ACCELERATOR = new CustomItem(Material.HAY_BLOCK, "&bAcelerador de Crecimiento Animal", "", "&rFunciona con &aAlimentos orgánicos", "", "&4Maquina End-Game", "&8\u21E8 &e\u26A1 &71024 J Buffer", "&8\u21E8 &e\u26A1 &728 J/s");;
	public static final ItemStack CROP_GROWTH_ACCELERATOR = new CustomItem(Material.DRIED_KELP_BLOCK, "&aAcelerante de cultivos", "", "&rFunciona con &aFertilizante orgánico", "", "&4Maquina End-Game", "&8\u21E8 &7Radio: 7x7", "&8\u21E8 &7Velocidad: &a3/time", "&8\u21E8 &e\u26A1 &71024 J Buffer", "&8\u21E8 &e\u26A1 &750 J/s");
	public static final ItemStack CROP_GROWTH_ACCELERATOR_2 = new CustomItem(Material.DRIED_KELP_BLOCK, "&aAcelerante de cultivos &7(&eII&7)", "", "&rFunciona con &aFertilizante orgánico", "", "&4Maquina End-Game", "&8\u21E8 &7Radio: 9x9", "&8\u21E8 &7Velocidad: &a4/time", "&8\u21E8 &e\u26A1 &71024 J Buffer", "&8\u21E8 &e\u26A1 &760 J/s");

	public static final ItemStack FOOD_FABRICATOR = new CustomItem(Material.GREEN_STAINED_GLASS, "&cFabricador de alimentos", "", "&rProduce &aComida Orgánica", "", "&6Maquina avanzada", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &7256 J Buffer", "&8\u21E8 &e\u26A1 &714 J/s");
	public static final ItemStack FOOD_FABRICATOR_2 = new CustomItem(Material.GREEN_STAINED_GLASS, "&cFabricador de alimentos &7(&eII&7)", "", "&rProduce &aComida Orgánica", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 6x", "&8\u21E8 &e\u26A1 &7512 J Buffer", "&8\u21E8 &e\u26A1 &748 J/s");
	
	public static final ItemStack FOOD_COMPOSTER = new CustomItem(Material.COMPOSTER, "&cCompostador de alimentos", "", "&rProduce &aFertilizante orgánico", "", "&6Maquina avanzada", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &7256 J Buffer", "&8\u21E8 &e\u26A1 &716 J/s");
	public static final ItemStack FOOD_COMPOSTER_2 = new CustomItem(Material.COMPOSTER, "&cCompostador de alimentos &7(&eII&7)", "", "&rProduce &aFertilizante orgánico", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 10x", "&8\u21E8 &e\u26A1 &7512 J Buffer", "&8\u21E8 &e\u26A1 &752 J/s");
	...
	public static final ItemStack FREEZER = new CustomItem(Material.LIGHT_BLUE_STAINED_GLASS, "&bCongelador", "", "&6Maquina avanzada", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &7256 J Buffer", "&8\u21E8 &e\u26A1 &718 J/s");;
	public static final ItemStack FREEZER_2 = new CustomItem(Material.LIGHT_BLUE_STAINED_GLASS, "&bCongelador &7(&eII&7)", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 2x", "&8\u21E8 &e\u26A1 &7256 J Buffer", "&8\u21E8 &e\u26A1 &730 J/s");;
	
	public static final ItemStack ELECTRIC_GOLD_PAN = new CustomItem(Material.BROWN_TERRACOTTA, "&6Charola de oro eléctrica", "", "&eMáquina básica", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &72 J/s");
	public static final ItemStack ELECTRIC_GOLD_PAN_2 = new CustomItem(Material.BROWN_TERRACOTTA, "&6Charola de oro eléctrica &7(&eII&7)", "", "&eMáquina básica", "&8\u21E8 &7Velocidad: 3x", "&8\u21E8 &e\u26A1 &74 J/s");
	public static final ItemStack ELECTRIC_GOLD_PAN_3 = new CustomItem(Material.BROWN_TERRACOTTA, "&6Charola de oro eléctrica &7(&eIII&7)", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 10x", "&8\u21E8 &e\u26A1 &714 J/s");

	public static final ItemStack ELECTRIC_DUST_WASHER = new CustomItem(Material.LOOM, "&3Lavadora de polvo eléctrica", "", "&eMáquina básica", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &76 J/s");
	public static final ItemStack ELECTRIC_DUST_WASHER_2 = new CustomItem(Material.LOOM, "&3Lavadora de polvo eléctrica &7(&eII&7)", "", "&eMáquina básica", "&8\u21E8 &7Velocidad: 2x", "&8\u21E8 &e\u26A1 &710 J/s");
	public static final ItemStack ELECTRIC_DUST_WASHER_3 = new CustomItem(Material.LOOM, "&3Lavadora de polvo eléctrica &7(&eIII&7)", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 10x", "&8\u21E8 &e\u26A1 &730 J/s");

	public static final ItemStack ELECTRIC_INGOT_FACTORY = new CustomItem(Material.BLAST_FURNACE, "&cFundidora de lingotes eléctrica", "", "&eMáquina básica", "&8\u21E8 &7Velocidad: 1x", "&8\u21E8 &e\u26A1 &78 J/s");
	public static final ItemStack ELECTRIC_INGOT_FACTORY_2 = new CustomItem(Material.BLAST_FURNACE, "&cFundidora de lingotes eléctrica &7(&eII&7)", "", "&eMáquina básica", "&8\u21E8 &7Velocidad: 2x", "&8\u21E8 &e\u26A1 &714 J/s");
	public static final ItemStack ELECTRIC_INGOT_FACTORY_3 = new CustomItem(Material.BLAST_FURNACE, "&cFundidora de lingotes eléctrica &7(&eIII&7)", "", "&4Maquina End-Game", "&8\u21E8 &7Velocidad: 8x", "&8\u21E8 &e\u26A1 &740 J/s");
	...
	public static final ItemStack FLUID_PUMP = new CustomItem(getSkull("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTQyM2FmOWY3NTNkMjQ0NGUwODdkZDE3YzYzMjUzMWRkMmRlNzE3NzQzZmFhMzUzZmZmNjI5ZGEyNTJiZSJ9fX0="), "&9Bomba de fluidos", "", "&6Maquina avanzada", "&8\u21E8 &e\u26A1 &732 J/Block");
	public static final ItemStack CHARGING_BENCH = new CustomItem(Material.BLAST_FURNACE, "&6Centro de carga", "", "&rCargas items tales como los Jetpacks", "", "&eMáquina básica", "&8\u21E8 &e\u26A1 &7128 J Buffer", "&8\u21E8 &e\u26A1 &7Energy Loss: &c50%");
	...
	public static final ItemStack INFUSED_ELYTRA = new CustomItem(new CustomItem(ELYTRA, "&5Elytra Infundido"), new String[] {"MENDING-1"});
