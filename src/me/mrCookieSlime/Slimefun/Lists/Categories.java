...
public final class Categories {
	...
	public static final Category LUMPS_AND_MAGIC = new Category(new CustomItem(Material.FIRE_CHARGE, "&7Items mágicos", "", "&a> Click para abrir"), 2);
	public static final Category MAGIC = new Category(new CustomItem(Material.BLAZE_POWDER, "&7Gadgets Mágicos", "", "&a> Click para abrir"), 3);
	...
	public static final Category TECH_MISC = new Category(new CustomItem(Material.COMPARATOR, "&7Componentes técnicos", "", "&a> Click para abrir"), 2);
	public static final Category MAGIC_ARMOR = new Category(new CustomItem(Material.GOLDEN_CHESTPLATE, "&7Armaduras mágicas", "", "&a> Click para abrir"), 2);
