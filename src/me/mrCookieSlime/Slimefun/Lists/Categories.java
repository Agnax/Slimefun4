...
public final class Categories {
	...
	public static final Category MAGIC = new Category(new CustomItem(Material.ELYTRA, "&7Gadgets mágicos", "", LORE), 3);
	...
	// Seasonal Categories
	public static final SeasonalCategory CHRISTMAS = new SeasonalCategory(12, 1, new CustomItem(Material.NETHER_STAR, "&aN&ca&av&ci&ad&ca&ad", "", "&c> Haga clic para ayudar a &aSanta"));
	public static final SeasonalCategory VALENTINES_DAY = new SeasonalCategory(2, 2, new CustomItem(Material.POPPY, "&dDía de San Valentín", "", "&d> Haz clic para celebrar el amor"));
	public static final SeasonalCategory EASTER = new SeasonalCategory(4, 2, new CustomItem(Material.EGG, "&6Pascua", "", "&a> Haz clic para pintar algunos huevos"));
	public static final SeasonalCategory BIRTHDAY = new SeasonalCategory(10, 1, new CustomItem(Material.FIREWORK_ROCKET, "&a&lCumpleaños de TheBusyBiscuit &7(26 de Octubre)", "", "&a> Haz clic para celebrar conmigo"));
