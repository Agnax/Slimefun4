...
public final class ResearchSetup {
	...
	public static void setupResearches() {
	    ...
	    Slimefun.registerResearch(new Research(40, "Hierro dorado Armor", 16), SlimefunItems.GILDED_IRON_HELMET, SlimefunItems.GILDED_IRON_CHESTPLATE, SlimefunItems.GILDED_IRON_LEGGINGS, SlimefunItems.GILDED_IRON_BOOTS);
	    ...
	    Slimefun.registerResearch(new Research(59, "Talisman del Anvil", 18), SlimefunItems.TALISMAN_ANVIL);
	    Slimefun.registerResearch(new Research(60, "Talisman del Minero", 18), SlimefunItems.TALISMAN_MINER);
	    Slimefun.registerResearch(new Research(61, "Talisman del Hunter", 18), SlimefunItems.TALISMAN_HUNTER);
	    Slimefun.registerResearch(new Research(62, "Talisman del Lava Walker", 18), SlimefunItems.TALISMAN_LAVA);
	    Slimefun.registerResearch(new Research(63, "Talisman del Water Breather", 18), SlimefunItems.TALISMAN_WATER);
	    Slimefun.registerResearch(new Research(64, "Talisman del Angel", 18), SlimefunItems.TALISMAN_ANGEL);
	    Slimefun.registerResearch(new Research(65, "Talisman del Firefighter", 18), SlimefunItems.TALISMAN_FIRE);
	    Slimefun.registerResearch(new Research(67, "Firey Situation", 14), SlimefunItems.LAVA_CRYSTAL);
	    Slimefun.registerResearch(new Research(68, "Talisman del Magician", 20), SlimefunItems.TALISMAN_MAGICIAN);
	    Slimefun.registerResearch(new Research(69, "Talisman del Traveller", 20), SlimefunItems.TALISMAN_TRAVELLER);
	    Slimefun.registerResearch(new Research(70, "Talisman del Warrior", 20), SlimefunItems.TALISMAN_WARRIOR);
	    Slimefun.registerResearch(new Research(71, "Talisman del Knight", 20), SlimefunItems.TALISMAN_KNIGHT);
	    ...
	    Slimefun.registerResearch(new Research(75, "Talisman del Whirlwind", 19), SlimefunItems.TALISMAN_WHIRLWIND);
	    Slimefun.registerResearch(new Research(76, "Talisman del Wizard", 22), SlimefunItems.TALISMAN_WIZARD);
	    ...
	    Slimefun.registerResearch(new Research(95, "Lazy Minado", 40), SlimefunItems.DIGITAL_MINER);
	    ...
	    Slimefun.registerResearch(new Research(100, "Granjero Shoes", 4), SlimefunItems.FARMER_SHOES);
	    ...
	    Slimefun.registerResearch(new Research(124, "Pickaxe of Vein Minado", 29), SlimefunItems.PICKAXE_OF_VEIN_MINING);
	    ...
	    Slimefun.registerResearch(new Research(179, "Android programables", 50), SlimefunItems.PROGRAMMABLE_ANDROID, SlimefunItems.PROGRAMMABLE_ANDROID_FARMER, SlimefunItems.PROGRAMMABLE_ANDROID_BUTCHER, SlimefunItems.PROGRAMMABLE_ANDROID_FISHERMAN, SlimefunItems.PROGRAMMABLE_ANDROID_MINER, SlimefunItems.PROGRAMMABLE_ANDROID_WOODCUTTER);
	    ...
	    Slimefun.registerResearch(new Research(195, "Advanced Androids - Carnicero", 30), SlimefunItems.PROGRAMMABLE_ANDROID_2_BUTCHER);
	    Slimefun.registerResearch(new Research(196, "Advanced Androids - Pescador", 30), SlimefunItems.PROGRAMMABLE_ANDROID_2_FISHERMAN);
	    ...
	    Slimefun.registerResearch(new Research(201, "Upgraded Acelerador de crecimiento de cultivos", 44), SlimefunItems.CROP_GROWTH_ACCELERATOR_2);
	    ...
	    Slimefun.registerResearch(new Research(223, "Empowered Androids - Carnicero", 30), SlimefunItems.PROGRAMMABLE_ANDROID_3_BUTCHER);
	    Slimefun.registerResearch(new Research(224, "Empowered Androids - Pescador", 30), SlimefunItems.PROGRAMMABLE_ANDROID_3_FISHERMAN);
	    ...
	    Slimefun.registerResearch(new Research(233, "Advanced Androids - Granjero", 30), SlimefunItems.PROGRAMMABLE_ANDROID_2_FARMER);
	    ...
	    Slimefun.registerResearch(new Research(247, "GEO-Minero", 24), SlimefunItems.GEO_MINER);
