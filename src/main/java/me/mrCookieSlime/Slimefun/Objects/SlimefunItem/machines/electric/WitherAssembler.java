...
public class WitherAssembler extends SlimefunItem {
		...
		new BlockMenuPreset(getID(), "&5Ensamblador de Wither") {
			...
			public void newInstance(BlockMenu menu, Block b) {
				if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), "enabled") == null || BlockStorage.getLocationInfo(b.getLocation(), "enabled").equals("false")) {
					menu.replaceExistingItem(22, new CustomItem(new ItemStack(Material.GUNPOWDER), "&7Habilitado: &4\u2718", "", "&e> Haga clic para habilitar esta máquina"));
					...
					menu.replaceExistingItem(22, new CustomItem(new ItemStack(Material.REDSTONE), "&7Habilitado: &2\u2714", "", "&e> Haga clic para deshabilitar esta máquina"));
					menu.addMenuClickHandler(22, (p, slot, item, action) -> {
				...
				menu.replaceExistingItem(31, new CustomItem(new ItemStack(Material.PISTON), "&7Altura: &3" + offset + " bloque(s)", "", "&rClick izquierdo: &7+0.1", "&rClick Derecho: &7-0.1"));
	...
	private void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(1, new CustomItem(Material.WITHER_SKELETON_SKULL, "&7Ranura para cabeza de Wither", "", "&rEsta ranura acepta Cabezas de Esqueletos Wither"), ChestMenuUtils.getEmptyClickHandler());
		preset.addItem(7, new CustomItem(Material.SOUL_SAND, "&Ranura de arena de alma", "", "&rEsta ranura acepta arena de alma"), ChestMenuUtils.getEmptyClickHandler());
		preset.addItem(13, new CustomItem(Material.CLOCK, "&7Tiempo de espera: &b30 segundos", "", "&r¡Esta máquina tarda hasta medio minuto para operar", "&rasí que dale algo de tiempo!"), ChestMenuUtils.getEmptyClickHandler());
	}
